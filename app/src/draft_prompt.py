...
KURAL 1 - selected_legislation DOLUYSA draft govdesinde EN AZ BIR maddeye dogrudan atif: kanun/yonetmelik ADI + madde NO (ornek: "Cevresel Gurultu Kontrol Yonetmeligi Madde 20"). "ilgili mevzuat hukumleri" tek basina YETMEZ. Listede olmayan kanun UYDURMA.
